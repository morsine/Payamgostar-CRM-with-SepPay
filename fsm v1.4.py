...
discord = Discord(url="https://discord.com/api/webhooks/1074637115129876480/SdR4QwSGKc4EFW9WwdPNWh1y3hZHdM6Fj_-MguvO8JGWCXh9L92kx2WKsemqxyGRlpR0") #Discord Webhook address
...
def payment():
    ...
    raw_data = 'grant_type=password&username=fouladsetorg&password=@Sep123456&scope=SepCentralPcPos openid'
...
def handleinput(name):
    ...
    if hix == 3:
        ...
        TOKEN = "5888710849:AAHpt_3YGOyhNYYrHqph0hPBUlMfYZsZoTg"
        chat_id = "-776555537"
        conn = pyodbc.connect('Driver={SQL Server};'
                      f'Server={DATABASE_SERVER}\{DATABASE_INSTANCE};'
                      f'Database={DATABASE_NAME};'
